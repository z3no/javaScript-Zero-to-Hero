...
//
// console.log(`${averageScoreDolphins} vs ${averageScoreKoalas}`);
//
// if(averageScoreDolphins > averageScoreKoalas){
//     console.log("Congrats! The Dolphins win 🏆!");
// } else if(averageScoreDolphins === averageScoreKoalas){
//     console.log("It's a tie!");
// } else {
//     console.log("Congrats! The Koalas win 🏆!");
// }
...
//     console.log("Congrats! The Koalas win 🏆!");
// } else {
//     console.log("You both didn't get 100 points you lose!")
// }
...
if(averageScoreDolphins > averageScoreKoalas && averageScoreDolphins >= 100){
    ...
    console.log("You both didn't get 100 points you lose! No trophy 🏆 for anyone!")
}