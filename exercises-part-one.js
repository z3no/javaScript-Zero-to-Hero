...
console.log(population/2); // 5780000
population++;
console.log(population); // 11560001
...
const description = `${country} is in ${continent} and its ${population} well some speak ${language}.`;
console.log(description);
...
/* LECTURE: Taking Decisions: if/else Statements
        1. If your country's population is greater than 33 million, log a string like this to the console:
           ...
           Otherwise, log a string like 'Portugal's population is 22 million below average'
...
/* LECTURE: Logical Operators
        ...
        3. Write an if statement to help Sarah figure out if your country is right for her.
           You will need to write a condition that accounts for all of Sarah's criteria. Take your time with this, and
           check part of the solution if necessary.
        4. If yours is the right country, log a string like this: 'You should live in Portugal :)'. If not, log 'Portugal
           does not meet your criteria :('
        5. Probably your country does not meet all the criteria. So go back and temporarily change some variables in
           order to make the condition true (unless you live in Canada :D)
*/
...
/* LECTURE: The Conditional (Ternary) Operator
        1. If your country's population is greater than 33 million, use the ternary operator to log a string like
           this to the console: 'Portugal's population is above average'.
